...
The function that produces this output is `feed()` which can be applied to a single lanscape object and returns the number of plants, normalised per hectar, that is about to fall to livestock feeding.
